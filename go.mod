...
require (
	...
	github.com/jenkins-x-plugins/jx-secret v0.1.54
...
require (
	...
	github.com/jenkins-x/go-scm v1.11.9 // indirect
	github.com/jenkins-x/lighthouse-client v0.0.452 // indirect
...
replace (
	...
	// jx-pipeline
	github.com/jenkins-x-plugins/jx-pipeline => ../jx-pipeline
